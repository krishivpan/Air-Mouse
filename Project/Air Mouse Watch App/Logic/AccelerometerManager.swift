...
class AccelerometerManager: ObservableObject {
    ...
    @Published var calibrationDone = false // Moved this up for organization
    
    private var baselineX: Double = 0
    private var baselineY: Double = 0
    private var latestAcceleration: CMAcceleration? // <-- 1. ADD THIS
    ...
    func start() {
        ...
        motion.startAccelerometerUpdates(to: .main) { [weak self] data, _ in
            ...
            self.latestAcceleration = raw // <-- 2. ADD THIS
    ...
    private func finishCalibration() {
        ...
        // Automatically hide checkmark after 1.5 seconds
